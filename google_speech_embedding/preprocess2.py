...
def preprocess_libriphrase(wav_dir = '/home/work/data/LibriPhrase/LibriPhrase_diffspk_all',
                           csv_dir = '/home/work/data/LibriPhrase/data',
                           save_dir = '/home/work/data/PhonMatchNet/google_speech_embedding/',
        ...
        for db in train_csv if train else test_csv:
                csv_list = [str(x) for x in Path(csv_dir).rglob('*' + db + '*_all_utt*')]
...
def preprocess_google(wav_dir = '/home/work/data/google/google_speech_commands',
                      save_dir = '/home/work/data/PhonMatchNet/google_speech_embedding/',
...
def preprocess_qualcomm(wav_dir = '/home/work/data/qualcomm/qualcomm_keyword_speech_dataset',
                        save_dir = '/home/work/data/PhonMatchNet/google_speech_embedding/',
...
def main():
        save_dir='/home/work/data/PhonMatchNet/google_speech_embedding/DB/'
